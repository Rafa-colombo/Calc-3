...
def simulacao_visual():
    ...
    bola = sphere(pos=vector(-0.5, altura_inicial, 0), radius=0.2, color=color.white, make_trail=True)
    ...
    while True:
        ...
        scene.camera.pos = vector(10 + quicadas*25/abs(g.y), 1, 1 - quicadas*0.9) 
    ...
    resultado_texto.insert(tk.END, f"Número de movimentos(1): {quicadas-1}\n--------------\n")
